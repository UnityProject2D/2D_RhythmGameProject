...
namespace FronkonGames.Glitches.Artifacts
{
  ...
  public abstract partial class Inspector
  {
    ...
    /// <summary> Float [0, 1] field with reset. </summary>
    public static float Slider(string label, string tooltip, float value, float resetValue) => Slider(label, tooltip, value, 0.0f, 1.0f, resetValue);
    ...
    public static Vector2Int Vector2Field(string label, string tooltip, Vector2Int value, Vector2Int resetValue)
    {
      EditorGUILayout.BeginHorizontal();
      {
        value = EditorGUILayout.Vector2IntField(new GUIContent(label, tooltip), value);
